...
export default function Help() {
  const waLink = 'https://wa.me/923255910645?text=Hi!%20I%20need%20help%20with%20my%20order%20on%20Aura%20Avenue.';
  const waLinkShort = 'https://wa.me/923255910645';
    ...
    <div className="min-h-screen bg-paper">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-14">
          ...
          <a href={waLink} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center text-center gap-3 p-6 rounded-sm border border-sand-dark hover:border-[#25D366] hover:bg-[#25D366]/5 transition-all group">
          ...
          <a href="mailto:auraevenue@gmail.com" className="flex flex-col items-center text-center gap-3 p-6 rounded-sm border border-sand-dark hover:border-gold transition-all group">
        ...
        <div className="mt-12 text-center p-8 bg-cream border border-sand-dark rounded-sm">
          ...
          <a href={waLinkShort} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-[#1ebe5d] transition-colors">
