        ...
        <div className="grid md:grid-cols-2 gap-10 mt-6">
          ...
          <div className="flex flex-col">
            ...
            <button
              ...
              disabled={outOfStock}
              className="w-full mt-3 flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] disabled:opacity-50 text-white py-3 rounded-sm text-sm font-medium transition-colors"
            >
